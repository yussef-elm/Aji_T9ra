				...
				<div class="row justify-content-sm-center">
					<div class="cl-xl-7 col-lg-8 col-md-10">
						...
						<div class="section-tittle text-center mb-70">
							<h3>Parcourons Toutes les catégories</h3>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								...
								<p>est un langage de programmation orienté objet créé par
									James Gosling et Patrick Naughton...</p>
								<a href="#" class="read-more1">Lire la suite</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								...
								<p>désigne l’analyse de données depuis différentes
									perspectives et le fait de transformer ces données ...</p>
								<a href="#" class="read-more1">Lire la suite</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								<h5>
									<a href="#">Réseau informatique</a>
								</h5>
								<p>Est un ensemble d'équipements reliés entre eux pour
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								...
								<p>Est la version entreprise de la plate-forme "Java" qui se
									compose de l'environnement "JSE"...</p>
								<a href="#" class="read-more1">Lire la suite</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								...
								<p>Est l'ensemble des activités visant à organiser le bon
									déroulement d’un projet et à en atteindre les objectifs...</p>
								<a href="#" class="read-more1">Lire la suite</a>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="single-cat mb-50">
							...
							<div class="cat-cap">
								<h5>
									<a href="#">Recherche opérationnelle</a>
								</h5>
								<p>comme l'ensemble des méthodes et techniques rationnelles
									orientées vers la recherche du meilleur choix ...</p>
								<a href="#" class="read-more1">Lire la suite ></a>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="browse-btn2 text-center mt-50">
							<a href="ProfsControllerServlet" class="btn">Trouver plus de
								cours</a>
						</div>
					</div>
				</div>
							...
							<div class="row justify-content-between">
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									...
									<div class="single-counter text-center">
										...
										<span class="counter color-blue">12</span>
										<p class="color-blue">+ Etudiant</p>
									</div>
								</div>
								...
								<div class="col-lg-3 col-md-6 col-sm-6">
									...
									<div class="single-counter text-center">
										...
										<span class="counter color-red">6</span>
										<p class="color-red">+ Professeur</p>
									</div>
								</div>
							</div>
						</div>
